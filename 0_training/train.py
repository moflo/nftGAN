...
ds_train = tfds.load("opensea_dataset", split="train")
# import celebalocal
# ds_train = tfds.load('celebalocal', split='train')
print(ds_train)
...
if False:
    ...
    load_path = os.path.join("checkpoints/stylegan_64x64.ckpt")
    # load_path = os.path.join("checkpoints/checkpoint")
    print(load_path)
    style_gan.load_weights(load_path)

train(start_res=4, target_res=128, steps_per_epoch=5000, display_images=False)
